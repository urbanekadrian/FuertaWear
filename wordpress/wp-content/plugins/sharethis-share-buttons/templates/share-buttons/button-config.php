	...
	<div class="row">
		...
		<div class="st-radio-config button-config button-size">
			...
			<div class="button-config">
				...
				<div class="item tooltip">
					<span class="lbl native-counts">
						<?php echo esc_html__( 'Use native counts', 'sharethis-share-buttons' ); ?>
						<span class="tooltip-icon tooltipped" data-position="right" data-tooltip="Whenever possible, we'll get your share counts directly from social networks, rather than counting clicks on the buttons. This typically results a larger number being displayed next to your button." data-tooltip-id="955d8c43-2a79-989c-8ea5-37eeb63047ec">
							<svg fill="#fff" preserveAspectRatio="xMidYMid meet" height="1em" width="1em" viewBox="0 0 40 40">
								<g>
									<path d="m23.2 28v5.4q0 0.4-0.3 0.6t-0.6 0.3h-5.3q-0.4 0-0.7-0.3t-0.2-0.6v-5.4q0-0.3 0.2-0.6t0.7-0.3h5.3q0.4 0 0.6 0.3t0.3 0.6z m7.1-13.4q0 1.2-0.4 2.3t-0.8 1.7-1.2 1.3-1.3 1-1.3 0.8q-0.9 0.5-1.6 1.4t-0.6 1.5q0 0.4-0.2 0.8t-0.7 0.3h-5.3q-0.4 0-0.6-0.4t-0.2-0.8v-1q0-1.9 1.4-3.5t3.2-2.5q1.3-0.6 1.9-1.2t0.5-1.7q0-0.9-1-1.7t-2.4-0.7q-1.4 0-2.4 0.7-0.8 0.5-2.4 2.5-0.3 0.4-0.7 0.4-0.2 0-0.5-0.2l-3.7-2.8q-0.3-0.2-0.3-0.5t0.1-0.6q3.5-6 10.3-6 1.8 0 3.6 0.7t3.3 1.9 2.4 2.8 0.9 3.5z"></path>
								</g>
						...
						<div class="material-tooltip"><span><?php echo esc_html__( 'Whenever possible, we\'ll get your share counts directly from social networks, rather than counting clicks on the buttons. This typically results a larger number being displayed next to your button.', 'sharethis-share-buttons' ); ?></span><div class="backdrop" style="top: -7px; left: 0px; width: 14px; height: 14px; border-radius: 0px 14px 14px 0px; transform-origin: 5% 50% 0px; margin-top: 45px; margin-left: 0px; display: none; opacity: 0; transform: scaleX(1) scaleY(1);"></div></div>
					</span>
