			...
			<div class="button-config">
				...
				<div class="item tooltip">
					<span class="lbl native-counts">
						...
						<div class="material-tooltip"><span>Whenever possible, we'll get your share counts directly from social networks, rather than counting clicks on the buttons. This typically results a larger number being displayed next to your button.</span><div class="backdrop" style="top: -7px; left: 0px; width: 14px; height: 14px; border-radius: 0px 14px 14px 0px; transform-origin: 5% 50% 0px; margin-top: 45px; margin-left: 0px; display: none; opacity: 0; transform: scaleX(1) scaleY(1);"></div></div>
					</span>
